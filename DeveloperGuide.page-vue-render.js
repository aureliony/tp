...
with(this){return _c('ol',[_c('li',[_v("When "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" is called upon to execute a command, it is passed to an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" object which in turn uses an enum factory "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandType")]),_v(" to create the relevant enum (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandType.DELETE")]),_v(") with the input arguments.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandType")]),_v(" enum calls the relevant command's factory method to create a command object (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(").")]),_v(" "),_c('li',[_v("The command can communicate with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" when it is executed (e.g. to delete a person)."),_c('br'),_v("\nNote that although this is shown as a single step in the diagram above (for simplicity), in the code it can take several interactions (between the command object and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(") to achieve.")]),_v(" "),_c('li',[_v("The result of the command execution is returned back from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" as a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("String")]),_v(".")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" passes the first token to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandType")]),_v(" which dispatches the matching type of command.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" instantiates the command with the user input arguments.")]),_v(" "),_c('li',[_v("The command object (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(") uses "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArgumentTokenizer")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArgumentMultimap")]),_v(" and possibly "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ParserUtil")]),_v(" to break down and interpret the user input arguments.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("logistics managers who have a need to manage a significant number of contacts\nresponsible for logistical assets")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast and prefers typing to other forms of input")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("PICs of inventory items, amenities or transport")]),_v(" "),_c('li',[_v("PoCs of departments, external suppliers or maintenance services")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("take up excessive storage")]),_v(" "),_c('li',[_v("are not optimised for typing only")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("manage contacts and associated assets faster than a typical mouse/GUI driven app")]),_v(" "),_c('li',[_v("easily annotate contacts and assets with details")]),_v(" "),_c('li',[_v("easily search for information by any category")]),_v(" "),_c('li',[_v("easily copy contact information to clipboard")]),_v(" "),_c('li',[_v("is lightweight and able to import/export data in easy-to-view format")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …")]),_v(" "),_c('th',[_v("I want to …")]),_v(" "),_c('th',[_v("So that I can …")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add new contacts and assets")]),_v(" "),_c('td',[_v("keep track of these details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add tags to contacts")]),_v(" "),_c('td',[_v("categorize them according to my preferences and workflow")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete contacts")]),_v(" "),_c('td',[_v("update the list if a contact is no longer needed")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("edit contacts and assets")]),_v(" "),_c('td',[_v("change details without recreating contacts, as there are too many details to re-add")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("easily view my existing contacts from the GUI")]),_v(" "),_c('td',[_v("visually find the contacts I'm looking for")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("easily list, filter and navigate contacts")]),_v(" "),_c('td',[_v("access relevant information quickly")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("search contacts by any category (e.g. name, asset, etc.)")]),_v(" "),_c('td',[_v("easily find the relevant contact")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("quickly paste contact information (e.g. email) onto the clipboard")]),_v(" "),_c('td',[_v("use the contact information immediately after finding it")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("view a drop-down suggestion of commands")]),_v(" "),_c('td',[_v("efficiently navigate and utilize the app without extensive prior knowledge")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("see no advertisements")]),_v(" "),_c('td',[_v("not be distracted from my tasks")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add secondary personnel associated with an asset")]),_v(" "),_c('td',[_v("have a backup contact if the main person is unreachable")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("toggle between light/dark theme")]),_v(" "),_c('td',[_v("customize the app to my preferences")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("resize the app’s window")]),_v(" "),_c('td',[_v("easily use multiple apps at once")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("change the profile picture of each contact")]),_v(" "),_c('td',[_v("easily identify them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("easily search within the system even if I mistype a few words")]),_v(" "),_c('td',[_v("more easily locate relevant information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("hurried user")]),_v(" "),_c('td',[_v("have commands even with extra whitespaces accepted")]),_v(" "),_c('td',[_v("not waste time retyping commands")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("advanced user")]),_v(" "),_c('td',[_v("type shorter commands")]),_v(" "),_c('td',[_v("type commands faster")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("advanced user")]),_v(" "),_c('td',[_v("use keyboard shortcuts")]),_v(" "),_c('td',[_v("use the app more efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("advanced user")]),_v(" "),_c('td',[_v("add custom fields")]),_v(" "),_c('td',[_v("add more information to contacts")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AssetBook-3 (AB3)")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC1 - Add a contact")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to add a contact.")]),_v(" "),_c('li',[_v("User specifies details of the contact.")]),_v(" "),_c('li',[_v("System adds the contact.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("2a. System detects user input is invalid. "),_c('br'),_v("\n 2a1. System displays and error message. "),_c('br'),_v("\n 2a2. User enters new input. "),_c('br'),_v("\n Steps 2a1-2a2 are repeated until user input is valid. "),_c('br'),_v("\n Use case resumes from step 2.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC2 - List contacts")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to list contacts.")]),_v(" "),_c('li',[_v("System displays all contacts.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC3 - Search contacts")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to search contacts.")]),_v(" "),_c('li',[_v("User specifies details to search by.")]),_v(" "),_c('li',[_v("System displays all matching contacts.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC4 - Edit contacts")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User "),_c('span',{staticClass:"underline"},[_v("lists contacts(UC2)")]),_v(".")]),_v(" "),_c('li',[_v("User requests to edit a contact.")]),_v(" "),_c('li',[_v("User specifies the index of the contact and details to edit.")]),_v(" "),_c('li',[_v("System updates the contact.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("1a. System displays no contacts. "),_c('br'),_v("\n Use case ends. "),_c('br'),_v("\n3a. System detects user input is invalid. "),_c('br'),_v("\n 3a1. System displays and error message. "),_c('br'),_v("\n 3a2. User enters new input. "),_c('br'),_v("\n Steps 3a1-3a2 are repeated until user input is valid. "),_c('br'),_v("\n Use case resumes from step 3. "),_c('br')])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC5 - Delete contact")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User "),_c('span',{staticClass:"underline"},[_v("lists contacts(UC2)")]),_v(".")]),_v(" "),_c('li',[_v("User requests to delete a contact.")]),_v(" "),_c('li',[_v("User specifies the index of the contact to delete.")]),_v(" "),_c('li',[_v("System deletes the contact.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("3a. System detects user input is invalid. "),_c('br'),_v("\n 3a1. System displays and error message. "),_c('br'),_v("\n 3a2. User enters new input. "),_c('br'),_v("\n Steps 3a1-3a2 are repeated until user input is valid. "),_c('br'),_v("\n Use case resumes from step 3. "),_c('br')])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"product-design"}},[_v("Product Design"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#product-design","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Target user is clearly narrowed down to logistics managers.")]),_v(" "),_c('li',[_v("Majority of the target users are likely to find the app worth using.")]),_v(" "),_c('li',[_v("Users with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Features should fit together cohesively.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should be optimized for the target user (logistics managers).")]),_v(" "),_c('li',[_v("Should work on any mainstream OS as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should work without internet access.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("Should not crash under typical usage.")]),_v(" "),_c('li',[_v("Should not log or collect any unnecessary user data.")]),_v(" "),_c('li',[_v("Response time for all commands and operations should be less than 1 second.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"documentation"}},[_v("Documentation"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#documentation","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The target user should understand how to use the product easily by reading the User Guide.")]),_v(" "),_c('li',[_v("User Guide should have higher overall quality compared to AddressBook-Level3 (AB3).")]),_v(" "),_c('li',[_v("A new team member should understand the product's internal design easily by reading the Developer Guide.")]),_v(" "),_c('li',[_v("Developer Guide should have higher overall quality compared to AB3.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Asset")]),_v(": An item of logistical significance, may be amenities or inventory")]),_v(" "),_c('li',[_c('strong',[_v("Clipboard")]),_v(": The computer's storage for data that is copied and that will be produced by the paste command")]),_v(" "),_c('li',[_c('strong',[_v("Command")]),_v(": Text that a user inputs to interact with the application")]),_v(" "),_c('li',[_c('strong',[_v("Command Line Interface(CLI)")]),_v(": An interface where text commands are inputted by users to interact with the computer")]),_v(" "),_c('li',[_c('strong',[_v("Graphical User Interface(GUI)")]),_v(": The visual display of an application through which a user interacts with the computer")]),_v(" "),_c('li',[_c('strong',[_v("Logistics Manager")]),_v(": Anyone who manages inventory or amenities in a professional capacity")]),_v(" "),_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Person-In-Charge(PIC)")]),_v(": A contact responsible for an asset")]),_v(" "),_c('li',[_c('strong',[_v("Point-of-Contact(PoC)")]),_v(": A contact representing a responsible entity like a department or external business")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(": User added information associated to a contact e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("retired")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("temp staff")]),_v(", …")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Thu, 21 Mar 2024, 0:45:31 GMT+8]")])])])}
}];
